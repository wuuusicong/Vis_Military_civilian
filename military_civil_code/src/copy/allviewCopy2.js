...
class allView extends Component {
    ...
    drawTimeLine({packed, width}){
        ...
        let column_lin = svgLine.selectAll("g_line")
            ...
            .enter()
            .append("g");
        let textObj = {78:"Primary Degree",88:"Moderate Degree",99:"High Degree"};
        let textObj2 = {78:"low capital",88:"moderate capital",99:"high capital"};
        let circleObj = {78:4,88:8,99:10};
        console.log("wuwuwu");
        console.log(nodesDetect);
        column_lin.append("circle")
            .attr("class","x_tick_Line")
            .attr("cx",(item,index)=>{if (item["other"]===99){return item["x2"]+20}return item["x2"]+10})
            .attr("cy",12)
            .attr("r",(item,index)=>{
        ...
        column_lin.append("text")
            .attr("class","x_tick_text")
            .attr("x",(item,index)=>{if(item["other"]!==99){return item["x2"]-5}return item["x2"]-5})
            .attr("y",35)
    ...
    render() {
        ...
        return (
            <div id="all_container">
                ...
                <div id="container2" >
                    <LeafLet data={this.state.LeafLet}/>
                </div>
            </div>
        );
    }
